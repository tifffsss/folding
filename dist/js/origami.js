...
var Origami = function(elt){
	...
	this.closeAll = function() {
		...
		Array.prototype.forEach.call(this.elt.children, function(el) {
			self.updateRotate3d(this.ref,this.translateX,this.translateY);
		});
	};
	...
	this.init = function() {
		...
		Array.prototype.forEach.call(this.elt.children, function(el) {
			...
			self.updateRotate3d(this.clone,this.translateX,this.translateY);
